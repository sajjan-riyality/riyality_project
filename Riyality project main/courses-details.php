...
<!-- 
									...
									<div class="accordion custom-accordion-style-1" id="accordion1">
											...
											<div class="card-header" id="collapse1HeadingOne">
												<h4 class="card-title m-0">
													<a class="accordion-toggle text-color-dark font-weight-bold collapsed" data-bs-toggle="collapse" data-bs-target="#collapse1One" aria-expanded="false" aria-controls="collapse1One">
														Topic 1: Introduction to Core Java  <span class="text-color-default font-weight-regular opacity-6 text-1 d-inline-block ps-1 text-uppercase">-  4 Lectures - 12min</span>
													</a>
												</h4>
											</div>
											<div id="collapse1One" class="collapse" aria-labelledby="collapse1HeadingOne" data-bs-parent="#accordion1">
												<div class="card-body">
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>What is Java?</a>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>History and evolution of Java.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Installation and setup of Java Development Kit (JDK).</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Writing and running your first Java program.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
										...
										<div class="card card-default">
											<div class="card-header" id="collapse2HeadingOne">
												<h4 class="card-title m-0">
													<a class="accordion-toggle text-color-dark font-weight-bold collapsed" data-bs-toggle="collapse" data-bs-target="#collapse2One" aria-expanded="false" aria-controls="collapse2One">
														Topic 2: Java Basics <span class="text-color-default font-weight-regular opacity-6 text-1 d-inline-block ps-1 text-uppercase">-  7 Lectures - 30min</span>
													</a>
												</h4>
											</div>
											<div id="collapse2One" class="collapse" aria-labelledby="collapse2HeadingOne" data-bs-parent="#accordion1">
												<div class="card-body">
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Need Of java .</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Feature of java.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>First Java Programm.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Variable and its Types.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
														...
														<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Method and its Types.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
														...
														<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Static And Non Static Members.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Access Specifiers.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
										...
										<div class="card card-default">
											<div class="card-header" id="collapse3HeadingOne">
												<h4 class="card-title m-0">
													<a class="accordion-toggle text-color-dark font-weight-bold collapsed" data-bs-toggle="collapse" data-bs-target="#collapse3One" aria-expanded="false" aria-controls="collapse3One">
														Topic 3: Object-Oriented Programming (OOP) <span class="text-color-default font-weight-regular opacity-6 text-1 d-inline-block ps-1 text-uppercase">-  10 Lectures - 50min</span>
													</a>
												</h4>
											</div>
											<div id="collapse3One" class="collapse" aria-labelledby="collapse1HeadingOne" data-bs-parent="#accordion1">
												<div class="card-body">
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Classes and objects.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Constructors and methods.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Inheritance and polymorphism.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Encapsulation.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Data Hiding.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Abstraction.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>inheritance.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Polymorphism.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Abstract Class.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Interface.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
										...
										<div class="card card-default">
											<div class="card-header" id="collapse4HeadingOne">
												<h4 class="card-title m-0">
													<a class="accordion-toggle text-color-dark font-weight-bold collapsed" data-bs-toggle="collapse" data-bs-target="#collapse4One" aria-expanded="false" aria-controls="collapse4One">
														Topic 4: java.lang Package <span class="text-color-default font-weight-regular opacity-6 text-1 d-inline-block ps-1 text-uppercase">-  4 Lectures - 12min</span>
													</a>
												</h4>
											</div>
											<div id="collapse4One" class="collapse" aria-labelledby="collapse1HeadingOne" data-bs-parent="#accordion1">
												<div class="card-body">
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Object Class.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>String.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>String Buffur and Builder Class.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Wrapper Class.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
										...
										<div class="card card-default">
											<div class="card-header" id="collapse4HeadingOne">
												<h4 class="card-title m-0">
													<a class="accordion-toggle text-color-dark font-weight-bold collapsed" data-bs-toggle="collapse" data-bs-target="#collapse5One" aria-expanded="false" aria-controls="collapse5One">
														Topic 5: JVM Architecture <span class="text-color-default font-weight-regular opacity-6 text-1 d-inline-block ps-1 text-uppercase">-  4 Lectures - 12min</span>
													</a>
												</h4>
											</div>
											<div id="collapse5One" class="collapse" aria-labelledby="collapse1HeadingOne" data-bs-parent="#accordion1">
												<div class="card-body">

													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Class Loader SubSystem.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Memory Area.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>Execution Engine.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
													...
													<div class="row align-items-md-center py-1">
														<div class="col-md-9">
															<a href="#" class="text-color-secondary font-weight-semi-bold text-2 line-height-1 mb-4"><i class="far fa-play-circle d-inline-block me-2 text-4 p-relative top-1"></i>JIT Compiler.</a>
														</div>
														<div class="col-md-3 text-md-end">
															<p class="text-color-default font-weight-semi-bold text-2 line-height-1 mb-0 opacity-5">4:26</p>
														</div>
