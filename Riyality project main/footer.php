					...
					<div class="row py-5">
						...
						<div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
							...
							<ul class="list list-unstyled text-color-tertiary opacity-6">
								...
								<li>
									Email: <a href="https://www.okler.net/cdn-cgi/l/email-protection#e3868e828a8fa3878c8e828a8dcd808c8e" class="text-decoration-none text-color-tertiary text-color-hover-primary"><span class="__cf_email__" data-cfemail="01716e73756e41656e6c60686f2f626e6c">[email&#160;protected]</span></a>
								</li>
							</ul>
						</div>
			    ...
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			        <!-- Start Registration & Faq 
			          ============================================= -->
			        <div class="reg-area inc-faq default-padding" id="register">
			          <div class="container">
			            <div class="row">
			              <div class="reg-items">
			                      ...
			                      <div class="row">
			                        <div class="col-md-6">
			                          <div class="form-group">
			                            <input class="form-control" id="firstName" name="name" placeholder="First Name" type="text" required>
			                          </div>
			                        </div>
			                        <div class="col-md-6">
			                          <div class="form-group">
			                          ...
			                          <div class="row">
			                            <div class="col-md-6 form-group">
			                              <select id="course" name="course" required>
			                                <option value="course"  selected id="courseName">Choose Subject</option>
			                            ...
			                            <div class="float-end col-md-6">
			                              <strong class="text-primary text-5" id="courseValue">$79</strong>
			                            </div>
			                          </div>
			                        </div>
			                        <div class="col-md-12">
			                          <div class="form-group">
			                            <input class="form-control" name="mobile" placeholder="Phone*" id="mobileNumber" type="tel" pattern="[0-9]{10}" required>
			      ...
			      <div class="modal-footer">
			        ...
			        <button type="submit" form="registrationForm" class="btn btn-primary">Register Now</button>
			      </div>
			    </div>
			  </div>
			</div>
