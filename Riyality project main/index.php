			...
			<div role="main" class="main">
						...
						<div class="owl-stage-outer">
							<div class="owl-stage">
								...
								<div class="owl-item position-relative overflow-hidden">
									...
									<img src="img/demos/education/slides/slide-1-1.png" class="img-fluid position-absolute bottom-0 d-none d-lg-block custom-slider-el-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600" alt="" />
								...
								<div class="owl-item position-relative overflow-hidden">
									...
									<img src="img/demos/education/slides/slide-2-1.png" class="img-fluid position-absolute bottom-0 d-none d-lg-block custom-slider-el-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600" alt="" />
							...
							<div class="col-md-4 mb-4 mb-md-0">
								...
								<div class="feature-box feature-box-steps">
									...
									<div class="feature-box-icon bg-color-quaternary feature-box-icon-extra-large appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="250">
										<img class="icon-animated" width="100" height="46" src="img/demos/education/icons/icon-web-search-engine.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary'}" />
									</div>
							...
							<div class="col-md-4 mb-4 mb-md-0">
								...
								<div class="feature-box feature-box-steps">
									...
									<div class="feature-box-icon bg-color-quaternary feature-box-icon-extra-large appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="500">
										<img class="icon-animated" width="42" height="42" src="img/demos/education/icons/icon-list.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary ms-2'}" />
									</div>
							...
							<div class="col-md-4">
								...
								<div class="feature-box feature-box-steps">
									...
									<div class="feature-box-icon bg-color-quaternary feature-box-icon-extra-large appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="750">
										<img class="icon-animated" width="45" height="45" src="img/demos/education/icons/icon-laptop.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary'}" />
									</div>
				...
				<section class="section custom-bg-color-grey-1 border-0 m-0" id="courses">
					<div class="container position-relative my-4">
								...
								<div class="owl-carousel owl-theme nav-style-1 nav-outside nav-font-size-lg custom-nav-secondary mb-0" data-plugin-options="{'responsive': {'576': {'items': 1}, '768': {'items': 2}, '992': {'items': 2}, '1200': {'items': 3}}, 'loop': true, 'nav': true, 'dots': false, 'margin': 20}">
									<div>
										<div class="card custom-card-courses border-radius-0">
											...
											<div class="card-body">
												<p class="mb-0 text-1 p-relative top-5 text-uppercase">Rahul Sir</p>
												<h4 class="mb-3 text-color-secondary"><a href="courses-details.php" class="text-color-secondary" id="frontEnd" title="">front end development</a></h4>
												...
												<div class="float-end">
													<strong class="text-primary text-5" id="frontEndValue">$79</strong>
												</div>
												...
												<div class="col text-center">
								<!-- <a href="demo-education-courses.html" class="btn btn-secondary font-weight-bold btn-px-3  mt-4 mb-2 appear-animation enroll-btn" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="350">ENROLL NOW</a> -->
								               <button type="button" class="btn btn-secondary font-weight-bold btn-px-3  mt-4 mb-2 enroll-btn " data-appear-animation="fadeInUpShorterPlus" data-bs-toggle="modal" data-bs-target="#exampleModal"  id="frontEndBtn"  onclick="enroll(this.id)">
                                       ENROLL NOW
                                      </button>
						               	</div>
											</div>
									...
									<div>	
										<div class="card custom-card-courses border-radius-0">
											...
											<div class="card-body">
												<p class="mb-0 text-1 p-relative top-5 text-uppercase">Sachin sir</p>
												<h4 class="mb-3 text-color-secondary"><a href="courses-details.php" class="text-color-secondary" id="backEnd" title="">back end development</a></h4>
													<p class="card-text mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra lorem , consectetur adipiscing elit...</p>

												<div class="float-end">
													<strong class="text-primary text-5" id="backEndValue">$59</strong>
												</div>
												...
												<div class="col text-center ">
								<!-- <a href="demo-education-courses.html" class="btn btn-secondary font-weight-bold btn-px-3  mt-4 mb-2 appear-animation enroll-btn" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="350">ENROLL NOW</a> -->
								             <button type="button" class="btn btn-secondary font-weight-bold btn-px-3  mt-4 mb-2 enroll-btn " data-appear-animation="fadeInUpShorterPlus" data-bs-toggle="modal" data-bs-target="#exampleModal" id="backEndBtn"  onclick="enroll(this.id)"> ENROLL NOW
                                      </button>
						             	  </div> 
						             	</div>
										</div>
									...
									<div>
										<div class="card custom-card-courses border-radius-0">
											...
											<div class="card-body">
												<p class="mb-0 text-1 p-relative top-5 text-uppercase">chandu sir</p>
												<h4 class="mb-3 text-color-secondary"><a href="courses-details.php" class="text-color-secondary" id="fullStack" title="">full stack development</a></h4>
													<p class="card-text mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra lorem , consectetur adipiscing elit...</p>

												<div class="float-end">
													<strong class="text-primary text-5" id="fullStackValue">$29</strong>
												</div>
												...
												<div class="text-2">
													...
													<div class="col text-center">
								                 <!-- <a href="demo-education-courses.html" class="btn btn-secondary font-weight-bold  btn-px-3 mt-4 mb-2 appear-animation enroll-btn" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="350">ENROLL NOW</a> -->
								                   <button type="button" class="btn btn-secondary font-weight-bold btn-px-3  mt-4 mb-2 enroll-btn " data-appear-animation="fadeInUpShorterPlus" data-bs-toggle="modal" data-bs-target="#exampleModal"  id="fullstackBtn"  onclick="enroll(this.id)">
                                             ENROLL NOW
                                      </button>
							                  </div>
									...
									<div>
										<div class="card custom-card-courses border-radius-0">
											...
											<div class="card-body">
												<p class="mb-0 text-1 p-relative top-5 text-uppercase">Akash sir</p>
												<h4 class="mb-3 text-color-secondary"><a href="courses-details.php" class="text-color-secondary" id="WordPress" title="">WordPress</a></h4>
													<p class="card-text mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra lorem , consectetur adipiscing elit...</p>

												<div class="float-end">
													<strong class="text-primary text-5" id="WordPressValue">$29</strong>
												</div>
												...
												<div class="col text-center">
								                 <!-- <a href="demo-education-courses.html" class="btn btn-secondary font-weight-bold btn-px-3 mt-4 mb-2 appear-animation enroll-btn" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="350">ENROLL NOW</a> -->
								                   ...
								                   <button type="button" class="btn btn-secondary font-weight-bold btn-px-3  mt-4 mb-2 enroll-btn " data-appear-animation="fadeInUpShorterPlus" data-bs-toggle="modal" data-bs-target="#exampleModal" id="WordPressBtn"  onclick="enroll(this.id)">
                                           ENROLL NOW
                                          </button>
							                  </div>
						...
						<div class="row pt-2">
							<div class="col text-center">
								<a href="courses.PHP" class="btn btn-secondary font-weight-bold btn-px-5 btn-py-3 mt-4 mb-2 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="350">VIEW ALL</a>
							</div>
						</div>
					</div>
				</section>
										...
										<div class="row">
											<div class="col px-4">
												...
												<div class="countdown text-color-primary font-weight-semibold custom-countdown-style-1 justify-content-center mb-4 py-2 px-2" data-plugin-countdown data-plugin-options="{'textDay': 'DAYS', 'textHour': 'HRS', 'textMin': 'MIN', 'textSec': 'SEC', 'date': '2025/01/01 12:00:00', 'wrapperClass': 'text-color-primary', 'numberClass': 'font-weight-semibold text-color-primary'}"></div>
													...
													<form class="custom-form-style-1 contact-form" action="https://www.okler.net/previews/porto/10.2.0/php/contact-form.php" method="POST">
						...
						<div class="row pb-2 mb-1">
							<div class="col-md-4 mb-4 mb-md-0">
								...
								<div class="feature-box feature-box-steps">
									...
									<div class="feature-box-info appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="150">
										<!-- <p class="mt-2 pt-1 mb-0 text-1 p-relative top-5 text-uppercase">Step 1</p> -->
										<h4 class=" mt-2 pt-1  top-5 text-uppercase mb-0 text-color-secondary">Front end development</h4>
									</div>
								</div>
							...
							<div class="col-md-4 mb-4 mb-md-0">
								...
								<div class="feature-box feature-box-steps">
									...
									<div class="feature-box-info appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="300">
										<!-- <p class="mt-2 pt-1 mb-0 text-1 p-relative top-5 text-uppercase">Step 2</p> -->
										<h4 class=" mt-2 pt-1  top-5 text-uppercase mb-0 text-color-secondary">back end development</h4>
									</div>
								</div>
							...
							<div class="col-md-4">
								...
								<div class="feature-box feature-box-steps">
									...
									<div class="feature-box-info appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="450">
										<!-- <p class="mt-2 pt-1 mb-0 text-1 p-relative top-5 text-uppercase">Step 3</p> -->
										<h4 class="mt-2 pt-1  top-5 text-uppercase mb-0 text-color-secondary">full stack development</h4>
									</div>
								</div>
						...
						<div class="row pb-2 mb-1">
							<div class="col-md-4 mb-4 mb-md-0">
								...
								<div class="feature-box feature-box-steps">
									...
									<div class="feature-box-info appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="150">
										<!-- <p class="mt-2 pt-1 mb-0 text-1 p-relative top-5 text-uppercase">Step 1</p> -->
										<h4 class=" mt-2 pt-1  top-5 text-uppercase mb-0 text-color-secondary">jquery and react js
									</div>
								</div>
							...
							<div class="col-md-4 mb-4 mb-md-0">
								...
								<div class="feature-box feature-box-steps">
									...
									<div class="feature-box-info appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="300">
										<!-- <p class="mt-2 pt-1 mb-0 text-1 p-relative top-5 text-uppercase">Step 2</p> -->
										<h4 class="mt-2 pt-1  top-5 text-uppercase mb-0 text-color-secondary">anguler js</h4>
									</div>
								</div>
							...
							<div class="col-md-4">
								...
								<div class="feature-box feature-box-steps">
									...
									<div class="feature-box-info appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="450">
										<!-- <p class="mt-2 pt-1 mb-0 text-1 p-relative top-5 text-uppercase">Step 3</p> -->
										<h4 class=" mt-2 pt-1  top-5 text-uppercase mb-0 text-color-secondary">corporete traning</h4>
									</div>
								</div>
						...
						<div class="row pb-2 mb-1">
							<div class="col-md-4 mb-4 mb-md-0">
								...
								<div class="feature-box feature-box-steps">
									...
									<div class="feature-box-info appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="150">
										<!-- <p class="mt-2 pt-1 mb-0 text-1 p-relative top-5 text-uppercase">Step 1</p> -->
										<h4 class="mt-2 pt-1  top-5 text-uppercase mb-0 text-color-secondary">guest lecture</h4>
									</div>
								</div>
							...
							<div class="col-md-4 mb-4 mb-md-0">
								...
								<div class="feature-box feature-box-steps">
									...
									<div class="feature-box-info appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="300">
										<!-- <p class="mt-2 pt-1 mb-0 text-1 p-relative top-5 text-uppercase">Step 2</p> -->
										<h4 class=" mt-2 pt-1  top-5 text-uppercase mb-0 text-color-secondary">collage workshop</h4>
									</div>
								</div>
							...
							<div class="col-md-4">
								...
								<div class="feature-box feature-box-steps">
									...
									<div class="feature-box-info appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="450">
										<!-- <p class="mt-2 pt-1 mb-0 text-1 p-relative top-5 text-uppercase">Step 3</p> -->
										<h4 class="mt-2 pt-1  top-5 text-uppercase mb-0 text-color-secondary">framework </h4>
									</div>
								</div>
									...
									<div class="px-lg-5 mx-lg-5">
										<div class="testimonial testimonial-style-2 testimonial-with-quotes testimonial-quotes-primary mb-0">
											<div class="testimonial-author">
												<img src="img/clients/2.jpg" class="img-fluid rounded-circle" alt="">
											</div>
											<blockquote>
												<p class="mb-0 custom-font-1 fst-italic text-4 line-height-7">Riyality Software Services in Sangola is the  Outstanding training programs, a welcoming company environment, and a state-of-the-art lab for hands-on practice make it the best training institute in town..</p>
											</blockquote>
											<div class="testimonial-author">
												<p><strong class="font-weight-bold">Chandrakant Chavan</strong></p>
											</div>
										</div>
									</div>
									<div class="px-lg-5 mx-lg-5">
										<div class="testimonial testimonial-style-2 testimonial-with-quotes testimonial-quotes-primary mb-0">
											<div class="testimonial-author">
												<img src="img/clients/3.jpg" class="img-fluid rounded-circle" alt="">
											</div>
											<blockquote>
												<p class="mb-0 custom-font-1 fst-italic text-4 line-height-7"> "Riyality Software Services exceeded my expectations with their exceptional training programs. Highly recommended for anyone seeking technology industry.".</p>
											</blockquote>
											<div class="testimonial-author">
												<p><strong class="font-weight-bold">Akash Anuse</strong></p>
											</div>
										</div>
									</div>
									<div class="px-lg-5 mx-lg-5">
										<div class="testimonial testimonial-style-2 testimonial-with-quotes testimonial-quotes-primary mb-0">
											<div class="testimonial-author">
												<img src="img/clients/4.jpg" class="img-fluid rounded-circle" alt="">
											</div>
											<blockquote>
												<p class="mb-0 custom-font-1 fst-italic text-4 line-height-7"> Riyality Software Services has transformed my front-end development skills. Their training program made me a confident and proficient front-end developer.</p>
											</blockquote>
											<div class="testimonial-author">
												<p><strong class="font-weight-bold">Indrajeet Chalekar</strong></p>
											</div>
										</div>
									</div>
									<div class="px-lg-5 mx-lg-5">
										<div class="testimonial testimonial-style-2 testimonial-with-quotes testimonial-quotes-primary mb-0">
											<div class="testimonial-author">
												<img src="img/clients/7.jpg" class="img-fluid rounded-circle" alt="">
											</div>
											<blockquote>
												<p class="mb-0 custom-font-1 fst-italic text-4 line-height-7"> "Riyality Software Services sets the standard for excellence in training and development. it was greate transformation from BA student to React developer. Thank You Riyality"</p>
											</blockquote>
											<div class="testimonial-author">
												<p><strong class="font-weight-bold">Balaji Aiwale</strong></p>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="card border-0 border-radius-0 box-shadow-1">
										<div class="card-body p-3 z-index-1">
											<a href="demo-education-blog-post.html">
												<img class="card-img-top border-radius-0 mb-2" src="img/demos/education/blog/blog-1.jpg" alt="Card Image">
											</a>
							...
							<div class="col-lg-4 mb-4 mb-lg-0">
								<article class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
									<div class="card border-0 border-radius-0 box-shadow-1">
										<div class="card-body p-3 z-index-1">
											<a href="demo-education-blog-post.html">
												<img class="card-img-top border-radius-0 mb-2" src="img/demos/education/blog/blog-2.jpg" alt="Card Image">
											</a>
											<p class="text-uppercase text-color-default text-1 my-2">
												<time pubdate datetime="2024-01-10">10 Jan 2024</time> 
												<span class="opacity-3 d-inline-block px-2">|</span> 
							...
							<div class="col-lg-4 mb-4 mb-lg-0">
								<article class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
									<div class="card border-0 border-radius-0 box-shadow-1">
										<div class="card-body p-3 z-index-1">
											<a href="demo-education-blog-post.html">
												<img class="card-img-top border-radius-0 mb-2" src="img/demos/education/blog/blog-3.jpg" alt="Card Image">
											</a>
											<p class="text-uppercase text-color-default text-1 my-2">
												<time pubdate datetime="2024-01-10">10 Jan 2024</time> 
												<span class="opacity-3 d-inline-block px-2">|</span> 
											...
											<div class="card-body p-0">
												<h4 class="card-title text-5 font-weight-semi-bold pb-1 mb-2"><a class="text-color-secondary text-decoration-none" href="demo-education-blog-post.html">Lorem ipsum dolor sit amet</a></h4>
												<p class="card-text mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra lorem , consectetur adipiscing elit...</p>
												<a href="blog-post.PHP" class="btn btn-link font-weight-semibold text-decoration-none text-2 ps-0">READ MORE</a>
											</div>
										</div>
									</div>
								</article>
				...
				<!-- <section class="section section-background custom-section-background-2 bg-color-light border-0 m-0" style="background-image: url(img/demos/education/backgrounds/background-2.jpg); background-position: 0 100%; background-repeat: no-repeat; background-size: contain;">
					<div class="container position-relative my-4">
						...
						<div class="custom-element custom-element-pos-3 appear-animation" data-appear-animation="expandIn" data-appear-animation-delay="200">
							<div class="opacity-2" data-plugin-float-element data-plugin-options="{'startPos': 'bottom', 'speed': 0.8, 'transition': true, 'transitionDuration': 3000}">
								<img class="icon-animated" width="157" height="157" src="img/demos/education/elements/element-1.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-dark'}" />
							</div>
						</div>
									...
									<div class="col">
										<div class="feature-box feature-box-style-5">
											<div class="feature-box-icon appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="100">
												<img class="icon-animated" width="50" src="img/demos/education/icons/icon-medal.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary'}" />
											</div>
									...
									<div class="col">
										<div class="feature-box feature-box-style-5">
											<div class="feature-box-icon appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="200">
												<img class="icon-animated" width="50" src="img/demos/education/icons/icon-list.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary'}" />
											</div>
											<div class="feature-box-info">
												<div class="overflow-hidden">
									...
									<div class="col">
										<div class="feature-box feature-box-style-5">
											<div class="feature-box-icon appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="300">
												<img class="icon-animated" width="50" src="img/demos/education/icons/icon-badge.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary'}" />
											</div>
											<div class="feature-box-info">
												<div class="overflow-hidden">
