<!DOCTYPE html>
<html lang="en" data-style-switcher-options="{'showBordersStyle': true, 'showLayoutStyle': false, 'showBackgroundColor': false, 'changeLogo': false, 'borderRadius': 0, 'colorPrimary': '#ec4f4f', 'colorSecondary': '#332859', 'colorTertiary': '#e1e2e5', 'colorQuaternary': '#f3dbdb'}">
...
<head>
		...
		<link rel="stylesheet" type="text/css" href="css\enrollButton.css">

		<!-- Demo CSS -->		<link rel="stylesheet" href="css/demos/demo-education.css">

		<!-- Skin CSS -->		<link id="skinCSS" rel="stylesheet" href="css/skins/skin-education.css">

		<!-- Theme Custom CSS -->
		<link rel="stylesheet" href="css/custom.css">

		<!-- enroll button  -->
		<link rel="stylesheet" type="text/css" href="css\buttton-info.css">
									...
									<div class="header-row">
										<ul class="list list-unstyled list-inline mb-0">
											...
											<li class="list-inline-item me-4 mb-0 d-none d-md-inline-block">
												...
												<a href="https://www.okler.net/cdn-cgi/l/email-protection#40302f32342f00302f32342f3428252d256e232f2d" class="text-color-secondary text-color-hover-primary font-weight-semibold text-decoration-none text-2">
													<span class="__cf_email__" data-cfemail="e69689949289a69689949289928e838b83c885898b">[email&#160;protected]</span>
												</a>
											</li>
										</ul>
									</div>
