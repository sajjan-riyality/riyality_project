				...
				<div class="container">
					...
					<div class="row py-3">
						<div class="col">
							...
							<img class="img-fluid lazyload" src="img/lazy.png" data-src="img/demos/education/generic/generic-1.jpg" alt="" />
							...
							<div class="row justify-content-center my-5">
								<div class="col-lg-8 text-center">
									...
									<img src="img/demos/education/signature.png" class="img-fluid my-4" alt="" />
								</div>
							</div>
